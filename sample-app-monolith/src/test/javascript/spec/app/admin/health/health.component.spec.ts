...
import { IconnectSampleAppMonolithTestModule } from '../../../test.module';
import { IcHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { IcHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('IcHealthCheckComponent', () => {

        let comp: IcHealthCheckComponent;
        let fixture: ComponentFixture<IcHealthCheckComponent>;
        let service: IcHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [IconnectSampleAppMonolithTestModule],
                declarations: [IcHealthCheckComponent],
                providers: [
                    IcHealthService,
                    {
                        provide: NgbModal,
            ...
            }).overrideTemplate(IcHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(IcHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(IcHealthService);
        });
