...
public class OrderResourceIntTest {
    ...
    private static final String DEFAULT_ORDER_REMARKS = "AAAAAAAAAA";
    private static final String UPDATED_ORDER_REMARKS = "BBBBBBBBBB";
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order()
            ...
            .orderRemarks(DEFAULT_ORDER_REMARKS);
        return order;
    }
    ...
    public void createOrder() throws Exception {
        ...
        assertThat(testOrder.getOrderAmount()).isEqualTo(DEFAULT_ORDER_AMOUNT);
        assertThat(testOrder.getOrderDate()).isEqualTo(DEFAULT_ORDER_DATE);
        assertThat(testOrder.getNoOfItems()).isEqualTo(DEFAULT_NO_OF_ITEMS);
        assertThat(testOrder.getPaymentMode()).isEqualTo(DEFAULT_PAYMENT_MODE);
        assertThat(testOrder.getOrderRemarks()).isEqualTo(DEFAULT_ORDER_REMARKS);
    }
    ...
    @Test
    @Transactional
    public void checkNoOfItemsIsRequired() throws Exception {
        int databaseSizeBeforeTest = orderRepository.findAll().size();
        // set the field null
        order.setNoOfItems(null);
    ...
    public void getAllOrders() throws Exception {
        ...
        restOrderMockMvc.perform(get("/api/orders?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].orderRemarks").value(hasItem(DEFAULT_ORDER_REMARKS.toString())));
    }
    ...
    public void getOrder() throws Exception {
        ...
        restOrderMockMvc.perform(get("/api/orders/{id}", order.getId()))
            ...
            .andExpect(jsonPath("$.orderRemarks").value(DEFAULT_ORDER_REMARKS.toString()));
    }
    ...
    public void updateOrder() throws Exception {
        ...
        updatedOrder
            ...
            .orderRemarks(UPDATED_ORDER_REMARKS);
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getOrderAmount()).isEqualTo(UPDATED_ORDER_AMOUNT);
        assertThat(testOrder.getOrderDate()).isEqualTo(UPDATED_ORDER_DATE);
        assertThat(testOrder.getNoOfItems()).isEqualTo(UPDATED_NO_OF_ITEMS);
        assertThat(testOrder.getPaymentMode()).isEqualTo(UPDATED_PAYMENT_MODE);
        assertThat(testOrder.getOrderRemarks()).isEqualTo(UPDATED_ORDER_REMARKS);
    }
